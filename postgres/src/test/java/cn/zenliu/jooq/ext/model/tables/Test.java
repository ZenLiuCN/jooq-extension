...
import cn.zenliu.jooq.ext.postgres.JsonbJsonNodeBinding;
...
public class Test extends TableImpl<TestRecord> {
     ...
     */
    public final TableField<TestRecord, JsonNode> JSON = createField("json", org.jooq.impl.DefaultDataType.getDefaultDataType("\"test\".\"test_json\"").nullable(false), this, "", new JsonbJsonNodeBinding());
